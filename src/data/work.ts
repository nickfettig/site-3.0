...
export const workItems: WorkItemType[] = [
  {
    ...
    employment_dates: "May - August 2026",
    description:
      "I worked across the full robotics stack for automated seafood processing, from sensor hardware to cloud infrastructure. My primary focus was in-motion weight estimation: reading load-cell force data through two Beckhoff EL3356 terminals over EtherCAT, then building a per-fish weight-extraction pipeline over the continuous force stream.",
  },
  {
  ...
  },
  {
    ...
    description:
      "I TA for intro to intermediate level computer science and engineering courses for both the Computer Science and Engineering departments. I work directly with students to assist with homework, labwork, and test preparation. I also had a short stint as a live model for an art class!",
  },
];
