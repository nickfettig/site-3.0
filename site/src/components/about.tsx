...
export default function About() {
    ...
    <div id = "about">
        ...
        <ContentDiv>
            <h1 className={`${space.className} text-white font-medium text-2xl`}>Professional Work Experience</h1>
            ...
            <div className="grid grid-cols-4 gap-y-6 gap-x-4">
                {
                    workItems.map((item, idx) => {
                        ...
                        let lines = idx === workItems.length -1 ? <></> : <div className="h-px col-span-full bg-white/10" />;
