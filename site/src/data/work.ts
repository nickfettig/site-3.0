...
export const workItems: WorkItemType[] = [
    ...
    },
    {
        ...
        description: "I research deployment challenges for Reinforcement Learning-based Traffic Signal Control (TSC). I have organized 200+ works in the RL-based TSC field into a novel deployment challenge classification taxonomy in the form of a review paper to submit to ACM Computing Surveys. I have continued to work for the AI for Social Good lab remotely since the conclusion of my summer REU program."
    },
]